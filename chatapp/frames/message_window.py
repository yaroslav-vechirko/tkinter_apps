...
class MessageWindow(tk.Canvas):
    def __init__(self, container, *args, **kwargs):
        ...
        def configure_scrollable_region(event):
        ...
        self.message_frame.bind('<Configure>', configure_scrollable_region)
    ...
    def update_message_widgets(self, messages, message_labels):
        ...
        for message in messages:
            message_time = datetime.datetime.fromtimestamp(message['date']).strftime('%m-%d-%Y %H:%M:%S')
    ...
    def _create_message_bubble(self, container, message_content, message_time, message_labels):
        ...
        message_label = ttk.Label(container, text=message_content, wraplength=800, anchor='w', justify='left', style="Message.TLabel")
